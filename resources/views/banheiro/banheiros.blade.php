        ...
        <div class="card card-custom w-100">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">Banheiros
                        <span class="d-block text-muted pt-2 font-size-sm">Listagem de banheiros</span></h3>
                </div>
                <div class="card-toolbar">
                    <a href="{{ url('banheiro/novo') }}" class="btn btn-primary font-weight-bolder"><i class="fa fa-plus"></i> Novo</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
