                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="nome_abrev" class="form-control" placeholder="Nome Abreviado do Setor"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <select name="local" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                ...
                                @foreach($locais as $local)
                                    <option value="{{ $local->cd_local_prova_lop }}">{{ $local->cd_local_prova_lop }} - {{ $local->nm_local_prova_lop }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="rede" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" >
                                ...
                                @foreach($redes as $rede)
                                    <option value="{{ $rede->cd_rede_ensino_ree }}">{{ $rede->nm_rede_ensino_ree }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
