...
<body>	
	@forelse($candidatos as $key => $d)
		@if($contoleLocal != $d->local or $contoleSetor != $d->setor)
			...
			<div id="corpo">
                <p style="padding-top: -10px;"><strong>Relação Geral de Inscritos Por Local e Setor - Ordem Alfabética - PAINEL</strong>
				...
				<table id="tabelaDados1" style="font-size: 12px;" border="0" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: left; padding: 4px;">Inscrição</th>
                            <th style="text-align: left; padding: 4px;">Nome</th>
                            <th style="width:15%; padding: 4px; text-align: center;">CPF</th>
                            <th style="width:5%; padding: 4px; text-align: center;">Grupo</th>
